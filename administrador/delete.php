...
include('../app/controllers/administrador/show.administrador.php');
        ...
        <div class="col-md-5">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title">¿Esta seguro de eliminar el administrador?</h3>
            ...
            <div class="card-body"> 
              <div class="row">
                <div class="col-md-12">
                  <form action="../app/controllers//administrador//delete_administrador.php" method="post">
