...
include('../app/controllers/administrador/update_administrador.php');
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0">Actualizar Administrador</h1>
        </div><!-- /.col -->
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <form action="../app/controllers/administrador/update.php" method="post">
