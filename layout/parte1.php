...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <!-- Navbar es el muro de la pagina-->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">SISTEMA DE GERENCIA</a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a >
        <img src="<?php echo $URL; ?>/public/images/carro.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Transmaest Logis. </span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo $URL; ?>/administrador" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Listado de Usuario</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo $URL; ?>/administrador/create.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
